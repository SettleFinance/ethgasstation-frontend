...
COPY ./hack/supervisord.conf /supervisord.conf
COPY ./hack/php-fpm-www.conf /etc/php7/php-fpm.d/www.conf
COPY ./hack/nginx.conf.template /nginx.conf.template
COPY ./hack/docker-entrypoint.sh /docker-entrypoint.sh
